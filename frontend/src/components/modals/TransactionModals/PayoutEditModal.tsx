...
const PayoutEditModal: React.FC<PayoutEditModalProps> = ({ voucherNo, onClose, onRefresh }) => {
      ...
      try {
        ...
        if (transactions.length > 0) {
          ...
          if (debitTransaction) {
            ...
            setSelectedExpensePayables(debitTransaction.ledger.id.toString());
          ...
          if (creditTransaction) {
            ...
            setSelectedParticulars(creditTransaction.ledger.id.toString());
  ...
  console.log('transaction1',transaction1,'transaction2',transaction2);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="modal-content bg-white rounded-lg shadow-lg p-6 max-w-lg w-full">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold">Edit Pay Out - Voucher No: {voucherNo}</h2>
          <button
            onClick={onClose}
